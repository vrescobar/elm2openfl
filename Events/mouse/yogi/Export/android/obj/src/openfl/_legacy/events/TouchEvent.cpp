...
::openfl::_legacy::events::MouseEvent TouchEvent_obj::__createSimilar( ::String type,::openfl::_legacy::display::InteractiveObject related,::openfl::_legacy::display::InteractiveObject target){
	...
	HX_STACK_LINE(54)
	::openfl::_legacy::events::TouchEvent touchEvent = ::openfl::_legacy::events::TouchEvent_obj::__new(type,_g,_g1,this->localX,this->localY,this->sizeX,this->sizeY,(  (((related == null()))) ? ::openfl::_legacy::display::InteractiveObject(this->relatedObject) : ::openfl::_legacy::display::InteractiveObject(related) ),this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);		HX_STACK_VAR(touchEvent,"touchEvent");
	HX_STACK_LINE(56)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.events.TouchEvent"), hx::TCanCast< TouchEvent_obj> ,sStaticFields,sMemberFields,
