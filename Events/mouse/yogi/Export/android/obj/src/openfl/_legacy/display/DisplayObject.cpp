...
HX_STACK_ARG(type,"type")
{
	...
	HX_STACK_LINE(62)
	int _g = ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_id(this->__handle);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(62)
	this->__id = _g;
	HX_STACK_LINE(63)
...
bool DisplayObject_obj::dispatchEvent( ::openfl::_legacy::events::Event event){
	...
	struct _Function_1_1{
		inline static bool Block( hx::ObjectPtr< ::openfl::_legacy::display::DisplayObject_obj > __this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/DisplayObject.hx",75,0x32220b70)
			{
				HX_STACK_LINE(75)
				::openfl::_legacy::display::DisplayObjectContainer _g = __this->get_parent();		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(75)
				return (_g != null());
			}
			return null();
	...
	struct _Function_1_2{
		inline static bool Block( hx::ObjectPtr< ::openfl::_legacy::display::DisplayObject_obj > __this){
			...
			{
				HX_STACK_LINE(75)
				::openfl::_legacy::display::DisplayObjectContainer _g1 = __this->get_parent();		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(75)
				return (_g1 != __this);
			}
			return null();
...
::openfl::_legacy::geom::Rectangle DisplayObject_obj::getBounds( ::openfl::_legacy::display::DisplayObject targetCoordinateSpace){
	...
	HX_STACK_LINE(89)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_bounds(this->__handle,(  (((targetCoordinateSpace != null()))) ? Dynamic(targetCoordinateSpace->__handle) : Dynamic(null()) ),result,true);
	HX_STACK_LINE(90)
	return result;
}
...
::openfl::_legacy::geom::Rectangle DisplayObject_obj::getRect( ::openfl::_legacy::display::DisplayObject targetCoordinateSpace){
	...
	::openfl::_legacy::geom::Rectangle result = ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(98)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_bounds(this->__handle,targetCoordinateSpace->__handle,result,false);
	HX_STACK_LINE(99)
	return result;
}
...
::openfl::_legacy::geom::Point DisplayObject_obj::globalToLocal( ::openfl::_legacy::geom::Point point){
	...
	HX_STACK_LINE(106)
	::openfl::_legacy::geom::Point result = point->clone();		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(107)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_global_to_local(this->__handle,result);
	HX_STACK_LINE(108)
	return result;
}
...
bool DisplayObject_obj::hitTestObject( ::openfl::_legacy::display::DisplayObject obj){
	...
	struct _Function_1_1{
		inline static bool Block( ::openfl::_legacy::display::DisplayObject &obj){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/DisplayObject.hx",115,0x32220b70)
			{
				HX_STACK_LINE(115)
				::openfl::_legacy::display::DisplayObjectContainer _g = obj->get_parent();		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(115)
				return (_g != null());
			}
			return null();
	...
	if (((  (((  (((obj != null()))) ? bool(_Function_1_1::Block(obj)) : bool(false) ))) ? bool(_Function_1_2::Block(this)) : bool(false) ))){
		HX_STACK_LINE(117)
		::openfl::_legacy::geom::Rectangle currentBounds = this->getBounds(hx::ObjectPtr<OBJ_>(this));		HX_STACK_VAR(currentBounds,"currentBounds");
		HX_STACK_LINE(118)
		::openfl::_legacy::geom::Rectangle targetBounds = obj->getBounds(hx::ObjectPtr<OBJ_>(this));		HX_STACK_VAR(targetBounds,"targetBounds");
		HX_STACK_LINE(120)
...
{
		HX_STACK_LINE(131)
		return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_hit_test_point(this->__handle,x,y,shapeFlag,true);
	}
}
...
::openfl::_legacy::geom::Point DisplayObject_obj::localToGlobal( ::openfl::_legacy::geom::Point point){
	...
	::openfl::_legacy::geom::Point result = point->clone();		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(139)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_local_to_global(this->__handle,result);
	HX_STACK_LINE(140)
	return result;
}
...
Void DisplayObject_obj::__drawToSurface( Dynamic surface,::openfl::_legacy::geom::Matrix matrix,::openfl::_legacy::geom::ColorTransform colorTransform,::String blendMode,::openfl::_legacy::geom::Rectangle clipRect,bool smoothing){
{
		...
		HX_STACK_LINE(189)
		::openfl::_legacy::display::DisplayObject_obj::lime_display_object_draw_to_surface(this->__handle,surface,matrix,colorTransform,blendMode,clipRect);
	}
return null();
}
...
Void DisplayObject_obj::__fireEvent( ::openfl::_legacy::events::Event event){
{
		...
		if (((stack->length > (int)0))){
			...
			while((true)){
				...
				HX_STACK_LINE(229)
				stack->__get(i).StaticCast< ::openfl::_legacy::display::InteractiveObject >()->__dispatchEvent(event);
				HX_STACK_LINE(231)
				if ((event->__getIsCancelled())){
					HX_STACK_LINE(233)
					return null();
...
::openfl::_legacy::geom::ColorTransform DisplayObject_obj::__getColorTransform( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(275)
	::openfl::_legacy::geom::ColorTransform colorTransform = ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(colorTransform,"colorTransform");
	HX_STACK_LINE(276)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_color_transform(this->__handle,colorTransform,false);
	HX_STACK_LINE(277)
...
::openfl::_legacy::geom::ColorTransform DisplayObject_obj::__getConcatenatedColorTransform( ){
	...
	::openfl::_legacy::geom::ColorTransform colorTransform = ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(colorTransform,"colorTransform");
	HX_STACK_LINE(285)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_color_transform(this->__handle,colorTransform,true);
	HX_STACK_LINE(286)
	return colorTransform;
}
...
::openfl::_legacy::geom::Matrix DisplayObject_obj::__getConcatenatedMatrix( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(293)
	::openfl::_legacy::geom::Matrix matrix = ::openfl::_legacy::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());		HX_STACK_VAR(matrix,"matrix");
	HX_STACK_LINE(294)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_matrix(this->__handle,matrix,true);
	HX_STACK_LINE(295)
	return matrix;
}
...
Void DisplayObject_obj::__getInteractiveObjectStack( Array< ::Dynamic > stack){
{
		...
		HX_STACK_LINE(302)
		::openfl::_legacy::display::InteractiveObject interactive = this->__asInteractiveObject();		HX_STACK_VAR(interactive,"interactive");
		HX_STACK_LINE(304)
		if (((interactive != null()))){
			HX_STACK_LINE(306)
...
::openfl::_legacy::geom::Matrix DisplayObject_obj::__getMatrix( ){
	...
	::openfl::_legacy::geom::Matrix matrix = ::openfl::_legacy::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());		HX_STACK_VAR(matrix,"matrix");
	HX_STACK_LINE(322)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_matrix(this->__handle,matrix,false);
	HX_STACK_LINE(323)
	return matrix;
}
...
Void DisplayObject_obj::__getObjectsUnderPoint( ::openfl::_legacy::geom::Point point,Array< ::Dynamic > result){
{
		...
		HX_STACK_LINE(330)
		if ((::openfl::_legacy::display::DisplayObject_obj::lime_display_object_hit_test_point(this->__handle,point->x,point->y,true,false))){
			HX_STACK_LINE(332)
...
::openfl::_legacy::geom::Rectangle DisplayObject_obj::__getPixelBounds( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(341)
	::openfl::_legacy::geom::Rectangle bounds = ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());		HX_STACK_VAR(bounds,"bounds");
	HX_STACK_LINE(342)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_pixel_bounds(this->__handle,bounds);
	HX_STACK_LINE(343)
	return bounds;
}
...
Void DisplayObject_obj::__onAdded( ::openfl::_legacy::display::DisplayObject object,bool isOnStage){
{
		...
		if (((object == hx::ObjectPtr<OBJ_>(this)))){
			HX_STACK_LINE(352)
			::openfl::_legacy::events::Event event = ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::ADDED,true,false);		HX_STACK_VAR(event,"event");
			HX_STACK_LINE(353)
			event->set_target(hx::ObjectPtr<OBJ_>(this));
			HX_STACK_LINE(354)
		...
		if ((isOnStage)){
			HX_STACK_LINE(360)
			::openfl::_legacy::events::Event event = ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::ADDED_TO_STAGE,false,false);		HX_STACK_VAR(event,"event");
			HX_STACK_LINE(361)
			event->set_target(hx::ObjectPtr<OBJ_>(this));
			HX_STACK_LINE(362)
			this->dispatchEvent(event);
...
Void DisplayObject_obj::__onRemoved( ::openfl::_legacy::display::DisplayObject object,bool wasOnStage){
{
		...
		if (((object == hx::ObjectPtr<OBJ_>(this)))){
			HX_STACK_LINE(373)
			::openfl::_legacy::events::Event event = ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::REMOVED,true,false);		HX_STACK_VAR(event,"event");
			HX_STACK_LINE(374)
			event->set_target(hx::ObjectPtr<OBJ_>(this));
			HX_STACK_LINE(375)
			this->dispatchEvent(event);
		...
		if ((wasOnStage)){
			HX_STACK_LINE(381)
			::openfl::_legacy::events::Event event = ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::REMOVED_FROM_STAGE,false,false);		HX_STACK_VAR(event,"event");
			HX_STACK_LINE(382)
			event->set_target(hx::ObjectPtr<OBJ_>(this));
			HX_STACK_LINE(383)
			this->dispatchEvent(event);
...
Void DisplayObject_obj::__setColorTransform( ::openfl::_legacy::geom::ColorTransform colorTransform){
{
		...
		HX_STACK_ARG(colorTransform,"colorTransform")
		HX_STACK_LINE(392)
		::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_color_transform(this->__handle,colorTransform);
	}
return null();
}
...
Void DisplayObject_obj::__setMatrix( ::openfl::_legacy::geom::Matrix matrix){
{
		...
		HX_STACK_ARG(matrix,"matrix")
		HX_STACK_LINE(399)
		::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_matrix(this->__handle,matrix);
	}
return null();
}
...
::openfl::_legacy::display::DisplayObjectContainer DisplayObject_obj::__setParent( ::openfl::_legacy::display::DisplayObjectContainer parent){
	...
	if (((parent != null()))){
		HX_STACK_LINE(423)
		::openfl::_legacy::display::Stage _g2 = this->get_stage();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(423)
...
Float DisplayObject_obj::get_alpha( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(439)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_alpha(this->__handle);
}
...
Float DisplayObject_obj::set_alpha( Float value){
	...
	HX_STACK_LINE(442)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_alpha(this->__handle,value);
	HX_STACK_LINE(443)
	return value;
}
...
Dynamic DisplayObject_obj::get_opaqueBackground( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(450)
	int i = ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_bg(this->__handle);		HX_STACK_VAR(i,"i");
	HX_STACK_LINE(452)
...
Dynamic DisplayObject_obj::set_opaqueBackground( Dynamic value){
	...
	if (((value == null()))){
		HX_STACK_LINE(467)
		::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_bg(this->__handle,(int)0);
	}
	else{
		HX_STACK_LINE(471)
		::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_bg(this->__handle,value);
	}
	HX_STACK_LINE(475)
	return value;
}
...
::openfl::_legacy::display::BlendMode DisplayObject_obj::get_blendMode( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(482)
	int i = ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_blend_mode(this->__handle);		HX_STACK_VAR(i,"i");
	HX_STACK_LINE(483)
	return ::Type_obj::createEnumIndex(hx::ClassOf< ::openfl::_legacy::display::BlendMode >(),i,null());
}
...
::openfl::_legacy::display::BlendMode DisplayObject_obj::set_blendMode( ::openfl::_legacy::display::BlendMode value){
	...
	HX_STACK_LINE(490)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_blend_mode(this->__handle,_g);
	HX_STACK_LINE(491)
	return value;
}
...
bool DisplayObject_obj::get_cacheAsBitmap( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(496)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_cache_as_bitmap(this->__handle);
}
...
bool DisplayObject_obj::set_cacheAsBitmap( bool value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(499)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_cache_as_bitmap(this->__handle,value);
	HX_STACK_LINE(500)
	return value;
}
...
bool DisplayObject_obj::get_pedanticBitmapCaching( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(505)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_pedantic_bitmap_caching(this->__handle);
}
...
bool DisplayObject_obj::set_pedanticBitmapCaching( bool value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(508)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_pedantic_bitmap_caching(this->__handle,value);
	HX_STACK_LINE(509)
	return value;
}
...
Array< ::Dynamic > DisplayObject_obj::set_filters( Dynamic value){
	...
	if (((  ((!(((_g == null()))))) ? bool((value == null())) : bool(true) ))){
		...
		HX_STACK_LINE(540)
		{
			...
			while((true)){
				...
				if (((filter != null()))){
					HX_STACK_LINE(544)
					::openfl::_legacy::filters::BitmapFilter _g21 = filter->__Field(HX_CSTRING("clone"),true)();		HX_STACK_VAR(_g21,"_g21");
					HX_STACK_LINE(544)
	...
	HX_STACK_LINE(552)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_filters(this->__handle,this->__filters);
	HX_STACK_LINE(553)
...
::openfl::_legacy::display::Graphics DisplayObject_obj::get_graphics( ){
	...
	if (((this->__graphicsCache == null()))){
		HX_STACK_LINE(562)
		Dynamic _g = ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_graphics(this->__handle);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(562)
		::openfl::_legacy::display::Graphics _g1 = ::openfl::_legacy::display::Graphics_obj::__new(_g);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(562)
...
Float DisplayObject_obj::get_height( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(571)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_height(this->__handle);
}
...
Float DisplayObject_obj::set_height( Float value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(574)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_height(this->__handle,value);
	HX_STACK_LINE(575)
	return value;
}
...
::openfl::_legacy::display::DisplayObject DisplayObject_obj::set_mask( ::openfl::_legacy::display::DisplayObject value){
	...
	this->mask = value;
	HX_STACK_LINE(583)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_mask(this->__handle,(  (((value == null()))) ? Dynamic(null()) : Dynamic(value->__handle) ));
	HX_STACK_LINE(584)
	return value;
}
...
Float DisplayObject_obj::get_mouseX( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(589)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_mouse_x(this->__handle);
}
...
Float DisplayObject_obj::get_mouseY( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(590)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_mouse_y(this->__handle);
}
...
::String DisplayObject_obj::get_name( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(593)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_name(this->__handle);
}
...
::String DisplayObject_obj::set_name( ::String value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(596)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_name(this->__handle,value);
	HX_STACK_LINE(597)
	return value;
}
...
::openfl::_legacy::display::DisplayObject DisplayObject_obj::get_root( ){
	...
	if (((_g != null()))){
		HX_STACK_LINE(609)
		return ::openfl::_legacy::Lib_obj::get_current();
	}
	HX_STACK_LINE(613)
	return null();
}
...
Float DisplayObject_obj::get_rotation( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(618)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_rotation(this->__handle);
}
...
Float DisplayObject_obj::set_rotation( Float value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(621)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_rotation(this->__handle,value);
	HX_STACK_LINE(622)
	return value;
}
...
::openfl::_legacy::geom::Rectangle DisplayObject_obj::set_scale9Grid( ::openfl::_legacy::geom::Rectangle value){
	...
	HX_STACK_LINE(631)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_scale9_grid(this->__handle,this->__scale9Grid);
	HX_STACK_LINE(632)
	return value;
}
...
Float DisplayObject_obj::get_scaleX( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(637)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_scale_x(this->__handle);
}
...
Float DisplayObject_obj::set_scaleX( Float value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(640)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_scale_x(this->__handle,value);
	HX_STACK_LINE(641)
	return value;
}
...
Float DisplayObject_obj::get_scaleY( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(646)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_scale_y(this->__handle);
}
...
Float DisplayObject_obj::set_scaleY( Float value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(649)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_scale_y(this->__handle,value);
	HX_STACK_LINE(650)
	return value;
}
...
::openfl::_legacy::geom::Rectangle DisplayObject_obj::set_scrollRect( ::openfl::_legacy::geom::Rectangle value){
	...
	HX_STACK_LINE(659)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_scroll_rect(this->__handle,this->__scrollRect);
	HX_STACK_LINE(660)
	return value;
}
...
::openfl::_legacy::geom::Transform DisplayObject_obj::get_transform( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(678)
	return ::openfl::_legacy::geom::Transform_obj::__new(hx::ObjectPtr<OBJ_>(this));
}
...
::openfl::_legacy::geom::Transform DisplayObject_obj::set_transform( ::openfl::_legacy::geom::Transform value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(681)
	::openfl::_legacy::geom::Matrix _g = value->get_matrix();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(681)
	this->__setMatrix(_g);
	HX_STACK_LINE(682)
	::openfl::_legacy::geom::ColorTransform _g1 = value->get_colorTransform();		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(682)
...
bool DisplayObject_obj::get_visible( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(688)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_visible(this->__handle);
}
...
bool DisplayObject_obj::set_visible( bool value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(691)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_visible(this->__handle,value);
	HX_STACK_LINE(692)
	return value;
}
...
Float DisplayObject_obj::get_width( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(697)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_width(this->__handle);
}
...
Float DisplayObject_obj::set_width( Float value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(700)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_width(this->__handle,value);
	HX_STACK_LINE(701)
	return value;
}
...
Float DisplayObject_obj::get_x( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(706)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_x(this->__handle);
}
...
Float DisplayObject_obj::set_x( Float value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(709)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_x(this->__handle,value);
	HX_STACK_LINE(710)
	return value;
}
...
Float DisplayObject_obj::get_y( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(715)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_y(this->__handle);
}
...
Float DisplayObject_obj::set_y( Float value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(718)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_y(this->__handle,value);
	HX_STACK_LINE(719)
	return value;
}
...
Float DisplayObject_obj::get_z( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(724)
	return ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_z(this->__handle);
}
...
Float DisplayObject_obj::set_z( Float value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(727)
	::openfl::_legacy::display::DisplayObject_obj::lime_display_object_set_z(this->__handle,value);
	HX_STACK_LINE(728)
	return value;
}
...
Dynamic DisplayObject_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 1:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"mask") ) { if (inCallProp) return set_mask(inValue);mask=inValue.Cast< ::openfl::_legacy::display::DisplayObject >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_legacy::display::Graphics*/ ,(int)offsetof(DisplayObject_obj,graphics),HX_CSTRING("graphics")},
	{hx::fsObject /*::openfl::_legacy::display::LoaderInfo*/ ,(int)offsetof(DisplayObject_obj,loaderInfo),HX_CSTRING("loaderInfo")},
	{hx::fsObject /*::openfl::_legacy::display::DisplayObject*/ ,(int)offsetof(DisplayObject_obj,mask),HX_CSTRING("mask")},
	...
	{hx::fsObject /*::openfl::_legacy::display::DisplayObjectContainer*/ ,(int)offsetof(DisplayObject_obj,parent),HX_CSTRING("parent")},
	{hx::fsObject /*::openfl::_legacy::display::DisplayObject*/ ,(int)offsetof(DisplayObject_obj,root),HX_CSTRING("root")},
	{hx::fsObject /*::openfl::_legacy::display::Stage*/ ,(int)offsetof(DisplayObject_obj,stage),HX_CSTRING("stage")},
	...
	{hx::fsObject /*::openfl::_legacy::display::Graphics*/ ,(int)offsetof(DisplayObject_obj,__graphicsCache),HX_CSTRING("__graphicsCache")},
	{hx::fsInt,(int)offsetof(DisplayObject_obj,__id),HX_CSTRING("__id")},
	{hx::fsObject /*::openfl::_legacy::display::DisplayObjectContainer*/ ,(int)offsetof(DisplayObject_obj,__parent),HX_CSTRING("__parent")},
	{hx::fsObject /*::openfl::_legacy::geom::Rectangle*/ ,(int)offsetof(DisplayObject_obj,__scale9Grid),HX_CSTRING("__scale9Grid")},
	{hx::fsObject /*::openfl::_legacy::geom::Rectangle*/ ,(int)offsetof(DisplayObject_obj,__scrollRect),HX_CSTRING("__scrollRect")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.display.DisplayObject"), hx::TCanCast< DisplayObject_obj> ,sStaticFields,sMemberFields,
...
{
	lime_create_display_object= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_create_display_object"),(int)0);
	lime_display_object_get_graphics= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_graphics"),(int)1);
	lime_display_object_draw_to_surface= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_draw_to_surface"),(int)-1);
	lime_display_object_get_id= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_id"),(int)1);
	lime_display_object_get_x= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_x"),(int)1);
	lime_display_object_set_x= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_x"),(int)2);
	lime_display_object_get_y= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_y"),(int)1);
	lime_display_object_set_y= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_y"),(int)2);
	lime_display_object_get_z= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_z"),(int)1);
	lime_display_object_set_z= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_z"),(int)2);
	lime_display_object_get_scale_x= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_scale_x"),(int)1);
	lime_display_object_set_scale_x= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_scale_x"),(int)2);
	lime_display_object_get_scale_y= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_scale_y"),(int)1);
	lime_display_object_set_scale_y= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_scale_y"),(int)2);
	lime_display_object_get_mouse_x= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_mouse_x"),(int)1);
	lime_display_object_get_mouse_y= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_mouse_y"),(int)1);
	lime_display_object_get_rotation= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_rotation"),(int)1);
	lime_display_object_set_rotation= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_rotation"),(int)2);
	lime_display_object_get_bg= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_bg"),(int)1);
	lime_display_object_set_bg= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_bg"),(int)2);
	lime_display_object_get_name= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_name"),(int)1);
	lime_display_object_set_name= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_name"),(int)2);
	lime_display_object_get_width= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_width"),(int)1);
	lime_display_object_set_width= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_width"),(int)2);
	lime_display_object_get_height= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_height"),(int)1);
	lime_display_object_set_height= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_height"),(int)2);
	lime_display_object_get_alpha= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_alpha"),(int)1);
	lime_display_object_set_alpha= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_alpha"),(int)2);
	lime_display_object_get_blend_mode= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_blend_mode"),(int)1);
	lime_display_object_set_blend_mode= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_blend_mode"),(int)2);
	lime_display_object_get_cache_as_bitmap= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_cache_as_bitmap"),(int)1);
	lime_display_object_set_cache_as_bitmap= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_cache_as_bitmap"),(int)2);
	lime_display_object_get_pedantic_bitmap_caching= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_pedantic_bitmap_caching"),(int)1);
	lime_display_object_set_pedantic_bitmap_caching= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_pedantic_bitmap_caching"),(int)2);
	lime_display_object_get_visible= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_visible"),(int)1);
	lime_display_object_set_visible= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_visible"),(int)2);
	lime_display_object_set_filters= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_filters"),(int)2);
	lime_display_object_global_to_local= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_global_to_local"),(int)2);
	lime_display_object_local_to_global= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_local_to_global"),(int)2);
	lime_display_object_set_scale9_grid= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_scale9_grid"),(int)2);
	lime_display_object_set_scroll_rect= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_scroll_rect"),(int)2);
	lime_display_object_set_mask= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_mask"),(int)2);
	lime_display_object_set_matrix= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_matrix"),(int)2);
	lime_display_object_get_matrix= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_matrix"),(int)3);
	lime_display_object_get_color_transform= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_color_transform"),(int)3);
	lime_display_object_set_color_transform= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_set_color_transform"),(int)2);
	lime_display_object_get_pixel_bounds= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_pixel_bounds"),(int)2);
	lime_display_object_get_bounds= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_get_bounds"),(int)4);
	lime_display_object_hit_test_point= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_display_object_hit_test_point"),(int)5);
}
