	...
	HX_STACK_ARG(useWeakReference,"useWeakReference")
{
		...
		if ((!(this->__eventMap->exists(type)))){
			...
			HX_STACK_LINE(42)
			::openfl::_legacy::events::_EventDispatcher::Listener _g1 = ::openfl::_legacy::events::_EventDispatcher::Listener_obj::__new(listener,useCapture,priority);		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(42)
			list->push(_g1);
			HX_STACK_LINE(43)
			...
			HX_STACK_LINE(49)
			{
				...
				while((true)){
					...
					HX_STACK_LINE(51)
					if ((::Reflect_obj::compareMethods(list->__get(i).StaticCast< ::openfl::_legacy::events::_EventDispatcher::Listener >()->callback,listener))){
						HX_STACK_LINE(51)
						return null();
					}
				}
			...
			HX_STACK_LINE(55)
			::openfl::_legacy::events::_EventDispatcher::Listener _g2 = ::openfl::_legacy::events::_EventDispatcher::Listener_obj::__new(listener,useCapture,priority);		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(55)
			list->push(_g2);
			HX_STACK_LINE(56)
			list->sort(::openfl::_legacy::events::EventDispatcher_obj::__sortByPriority_dyn());
		}
	}
return null();
}
...
bool EventDispatcher_obj::dispatchEvent( ::openfl::_legacy::events::Event event){
	...
	while((true)){
		...
		HX_STACK_LINE(93)
		listener = list->__get(index).StaticCast< ::openfl::_legacy::events::_EventDispatcher::Listener >();
		HX_STACK_LINE(95)
		...
		HX_STACK_LINE(108)
		if (((listener == list->__get(index).StaticCast< ::openfl::_legacy::events::_EventDispatcher::Listener >()))){
			HX_STACK_LINE(110)
			(index)++;
		}
	}
	...
	HX_STACK_ARG(capture,"capture")
{
		...
		HX_STACK_LINE(137)
		{
			...
			while((true)){
				...
				int i = (_g1)++;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(139)
				if ((list->__get(i).StaticCast< ::openfl::_legacy::events::_EventDispatcher::Listener >()->match(listener,capture))){
					HX_STACK_LINE(141)
					list->splice(i,(int)1);
					HX_STACK_LINE(142)
					break;
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_legacy::events::IEventDispatcher*/ ,(int)offsetof(EventDispatcher_obj,__targetDispatcher),HX_CSTRING("__targetDispatcher")},
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.events.EventDispatcher"), hx::TCanCast< EventDispatcher_obj> ,sStaticFields,sMemberFields,
